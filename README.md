...
Остальной код можно найти [тут](./src/AVL_dict.clj)
...
Полное содержание ***unit*** тестов можно найти [тут](./test/units_test.clj)
...
Полное содержание ***property-based***  тестов можно найти [тут](./test/property_test.clj)
